...
{
    add_theme_page('Homepage content', 'Homepage content', 'edit_theme_options', 'aitrongcay-homepage-content', 'aitrongcay_render_homepage_admin_page');
}
add_action('admin_menu', 'aitrongcay_add_homepage_admin_page');
